...
class WLTCProfile:
    ...
    def get_cubed_velocity_integral(self, time: float) -> float: ...
    def get_time_for_travel_distance(self, time: float) -> float: ...
    @property
    def name(self) -> str: ...
    @property
    def path(self) -> str: ...
    ...
    @property
    def full_spline(self) -> Callable[[float], float]: ...
    @property
    def full_profile_distance(self) -> float: ...
    @property
    def repeatable_profile_distance(self) -> float: ...
    @property
    def start_offset_time(self) -> float: ...
    @property
    def end_offset_time(self) -> float: ...
    @property
    def spline_time(self) -> list[float]: ...
    @property
...
class Trip:
    ...
    def service_duration(self) -> int: ...
    def travel_duration(self, now: float, data: ProblemData) -> int: ...
...
class Route:
    ...
    def __getstate__(self) -> tuple: ...
    def __setstate__(self, state: tuple, /) -> None: ...
    def fuel_and_emission_cost(self, data: ProblemData) -> float: ...
    def wage_cost(self, data: ProblemData) -> float: ...
