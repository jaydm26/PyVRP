...
from instances.r112_21 import instance_data as r112_21
from instances.c208_21 import instance_data as c208_21


all_instances = [r112_21,c208_21]
velocity_behaviours = [
...
results_summary.to_csv("test_big_instance.csv", sep="\t")